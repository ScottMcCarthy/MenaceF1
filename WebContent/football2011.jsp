...
<%
			menJava.directoryTrawler("/var/www/html/extras/FootballPhotos2011/");
%>
...
<TABLE border="1" width="100%" bgcolor="#ffffff">
	<TBODY>
		<TR>
			...
			<TD align="center" width="431"><FONT size="6">Football Photos<BR>2010/2011 Season
...
<BR>
<%
			menJava.galleryFront("/var/www/html/extras/FootballPhotos2011/",out,"gallery.jsp");
%>
