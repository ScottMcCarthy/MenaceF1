...
<%
			menJava.directoryTrawler("/var/www/html/extras/FootballPhotos2007/");
%>
...
<TABLE border="1" width="100%" bgcolor="#ffffff">
	<TBODY>
		<TR>
			<TD width="121"><IMG border="0" src="images/emiratesstadium_badge.jpg"
				width="161" height="161"></TD>
			<TD align="center" width="431"><FONT size="6">Football Photos<BR>2006/2007 Season
...
<BR>
<%
			menJava.galleryFront("/var/www/html/extras/FootballPhotos2007/",out,"gallery.jsp");
%>
