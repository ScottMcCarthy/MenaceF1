...
<META name="GENERATOR" content="IBM WebSphere Studio">
	...
	<jsp:useBean id="fixtures" class="menaceF1.Fixtures" scope="session"/>
	<jsp:setProperty name="fixtures" property="*"/> 
		...
		<TR>
			...
			<TABLE border="0">
				<TBODY>
					...
					<% if(fixtures.submit().equals("0")) { %>
					<TR>
						<TD width="621"><B><BR>Fixtures entered succesfully
						</B><BR>Return to<BR>
						...
						<%} else { %>
							<TR>
							<TD width="621"><B><BR>There was an error while entering the fixtures.
							</B></TD>
						<%}%>
