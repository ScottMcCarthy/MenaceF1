			...
			<TABLE border="0">
				<TBODY>
					...
					<% 
						...
						String sqlcode = prediction.submitResults(); 
						preds.calculateScores();
					    if(sqlcode.equals("0")) { %>
					<TR>
						<TD align="center" width="621"><FONT color="green" size="4">Results entered succesfully!</FONT></TD>
					</tr>
					<tr>
						<TD width="621"><B>Return to<BR>
						<A href="admin.jsp"><IMG border="1" src="../images/admin.gif"
							width="134" height="97"></A></B><BR>
						</TD>
					...
					<TR>
						...
						<%} else {%>
					<tr>	
						<TD align="center" width="621"><FONT color="red" size="4">An unknown error occured while submitting the results!</FONT></TD>
					</TR>
					<TR>
