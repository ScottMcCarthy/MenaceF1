		...
		<TR>
			...
			<TABLE border="0">
				<TBODY>
					...
					<TR>
						<TD width="621"><B><BR>
						Select an administrative function from the list below:<BR>
						<BR>
						</B>
						<TABLE border="0" cellspacing="5">
							<TBODY>
								<TR>
									<TD colspan="2" align="center"><A href="enterResults.jsp"><IMG
										border="1" src="../images/results.gif" width="286" height="47"></A></TD>
									<TD></TD>
								</TR>
								<TR>
									<TD><A href="addFixtures.jsp"><IMG border="1"
										src="../images/addFixtures.gif" width="286" height="47"></A></TD>
									<TD><A href="moveFixture.jsp"><IMG border="1"
										src="../images/moveFixtures.gif" width="286" height="47"></A></TD>
								</TR>
								<TR>
									<TD><A href="enterNews.jsp"><IMG border="1"
										src="../images/news.gif" width="286" height="47"></A></TD>
									<TD><A href="readFeedback.jsp"><IMG border="1"
										src="../images/feedback.gif" width="286" height="47"></A></TD>
								</TR>
							</TBODY>
						</TABLE>
						<B></B></TD>
