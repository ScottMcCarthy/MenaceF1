		...
		<TR>
			...
			<TABLE border="0">
				<TBODY>
					<TR>
						<% if (player.isAdministrator()) { %>
						<TD align="center" width="621"><FONT color="green" size="4">Pred Admin Console<BR>
						<SMALL><A href="javascript:history.back()">Click here to return</A></SMALL>
						
						</FONT></TD>
					</TR>
					<TR>
						<TD width="621"><B><BR>
						Here are all the feedback messages received:<BR>
						<BR>
						</B>
						<% preds.showFeedback(out,request);%>
						<B></B></TD>
				<%} else { %>
					<TR>
