...
<script language="JavaScript">
	 <!-- hide
 	 function validate(matchday) {
 	 if (matchday.match1.selectedIndex == 0) {
 	 	alert("You must select a new matchday");
 	 	return false;
 	 	}
		...
		<TR>
			...
			<TABLE border="0">
				<TBODY>
					...
					<TR>
						<TD width="621"><B><BR>
						Select a fixture to move, and select the new matchday from the list below:<BR>
						<BR></b></form>
						<form action="moveFixture2.jsp" method="post" onSubmit="return validate(this)" >
					
						<select name="fixture">
						<% preds.moveFixtureSelect(out,request); %>
						</select>
						...
						<br><br>
						<input type ='submit' name="submit" value="Move Fixture">
