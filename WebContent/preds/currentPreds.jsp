...
<TABLE border="1" width="100%" bgcolor="#ffffff">
	<TBODY>
		<TR>
			...
			<TABLE border="0">
				<TBODY>
						<TR><TD width="523" align="center"><U><FONT color="green" size="4">All predictions for Matchday  <%out.print(preds.currentMatchPreds());%></FONT></U><BR><small><A
					...
					<TR>
						...
						<%preds.allActivePreds(out,request);%> </TD>
					</TR>
				</TBODY>
			</TABLE>
