...
<%
			menJava.directoryTrawler("/var/www/html/extras/FootballPhotos2008/");
%>
...
<TABLE border="1" width="100%" bgcolor="#ffffff">
	<TBODY>
		<TR>
			<TD width="121"><IMG border="0" src="images/wenger.jpg"
				width="269" height="202"></TD>
			<TD align="center" width="431"><FONT size="6">Football Photos<BR>2007/2008 Season
...
<BR>
<%
			menJava.galleryFront("/var/www/html/extras/FootballPhotos2008/",out,"gallery.jsp");
%>
