...
<%
			menJava.directoryTrawler("/var/www/html/extras/FootballPhotos2005/");
%>
...
<TABLE border="1" width="100%" bgcolor="#ffffff">
	<TBODY>
		<TR>
			<TD width="121"><IMG border="0" src="images/FACup_125_CornerLogo.gif"
				width="132" height="132"></TD>
			<TD align="center" width="431"><FONT size="6">Football Photos<BR>2004/2005 Season
...
<BR>
<%
			menJava.galleryFront("/var/www/html/extras/FootballPhotos2005/",out,"gallery.jsp");
%>
