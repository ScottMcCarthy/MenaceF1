...
<%
			menJava.directoryTrawler("/var/www/html/extras/FootballPhotos2009/");
%>
...
<TABLE border="1" width="100%" bgcolor="#ffffff">
	<TBODY>
		<TR>
			<TD width="121"><img border="0" src="images/wembley-stadium.jpg"
				width="322" height="246"></TD>
			<TD align="center" width="431"><FONT size="6">Football Photos<BR>2008/2009 Season
...
<BR>
<%
			menJava.galleryFront("/var/www/html/extras/FootballPhotos2009/",out,"gallery.jsp");
%>
