...
<%
			menJava.directoryTrawler("/var/www/html/extras/FootballPhotos2004/");
%>
...
<TABLE border="1" width="100%" bgcolor="#ffffff">
	<TBODY>
		<TR>
			<TD width="155"><IMG border="0" src="images/football_ball.jpg"
				width="154" height="154"></TD>
			<TD width="736" align="center"><FONT size="6">Football Photos<BR>2003/2004 Season
...
<BR>
<%
			menJava.galleryFront("/var/www/html/extras/FootballPhotos2004/",out,"gallery.jsp");
%>
