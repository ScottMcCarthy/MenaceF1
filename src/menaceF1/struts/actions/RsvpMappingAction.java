 ...
 * @author
 */
public class RsvpMappingAction extends Action

{
	...
	try {
	    ...
	    gu.updateGuestListFromRSVP(Integer.parseInt(request.getParameter("RSVPID")), Integer.parseInt(request.getParameter("realGuestID")));
